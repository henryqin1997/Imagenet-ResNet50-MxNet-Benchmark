...
from mlperf_log_utils import mx_resnet_print_event, mx_resnet_print_start, mx_resnet_print_end, mpiwrapper, \
...
if __name__ == '__main__':
    ...
    initializer = MLPerfInit(
        rnd_type='gaussian', factor_type="in", magnitude=2) if not args.bn_gamma_init0 else BNZeroInit(
